...
def average_one_hots(sent, word_to_ind):  # todo: the input of the simple log-linear
    """
...
def binary_accuracy(preds, y):
    ...
    """
    new_pred = np.apply_along_axis(func1d=data_loader.get_sentiment_class_from_val, axis=1, arr=preds)
    comparison = new_pred == y
